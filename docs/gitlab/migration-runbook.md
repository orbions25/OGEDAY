...
- Use `docs/gitlab/dns-change-request.md` for the DNS owner handoff.
- Use `docs/gitlab/server-provisioning-checklist.md` before server install.
- Use `docs/gitlab/phase-0-go-no-go.md` before moving to installation.
